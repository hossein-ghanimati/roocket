      ...
      >
        <Formik
          ...
          onSubmit={async (values) => {
            const loadingSwal = await showLoadingSwal({ task: "ورود" });
            ...
            if (token) {
              ...
              showConfirmSwal({
                ...
                callBack: (result) => {
                  result.isConfirmed &&
                    navigate(generateAuthPagesLink("register"));
                },
              });
            }
          }}
            ...
            <Form className="space-y-4">
              <div className="space-y-2">
                <div className="flex items-center relative">
                  ...
                  <MdOutlineLocalPostOffice className="absolute left-3 size-7 text-slate-500" />
                </div>
                {errors.identifier && (
