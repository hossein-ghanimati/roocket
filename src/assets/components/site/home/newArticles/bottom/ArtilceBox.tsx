      ...
      <div className="shadow-md xl:shadow-lg p-4 flex flex-col dark:bg-gray-950 bg-white rounded h-full">
        ...
        >
          <img            
            ...
            alt={shortName}
            src={`http://192.168.235.220:4000/courses/covers/${cover}`}
          />
        </Link>
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center justify-between">
                <img
                  ...
                  alt={creator.name}
                  src={creator.profile ? `http://192.168.235.220:4000/courses/covers${creator.profile}` : "/public/image/user/none.png"}
                />
                <b>
                  <span
