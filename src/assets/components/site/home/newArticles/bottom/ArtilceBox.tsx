      ...
      <div className="shadow-md xl:shadow-lg p-4 flex flex-col dark:bg-gray-950 bg-white rounded h-full">
        ...
        >
          <img            
            ...
            alt={shortName}
            src={`http://192.168.235.193:4000/courses/covers/${cover}`}
          />
        </Link>
        ...
        <div className="flex flex-col flex-1">
          <div className="flex flex-col flex-grow">
            <h4 className="mt-3 mb-4 ">
              <Link
                className="font-bold text-xl  text-justify transition duration-200  dark:hover:text-blue-450 hover:text-blue-700  dark:text-white text-gray-800 h-16 overflow-hidden"
                to={`/article/${shortName}`}
              >
                {title}
              </Link>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center justify-between">
                <img
                  ...
                  alt={creator.name}
                  src={creator.profile ? `http://192.168.235.193:4000/courses/covers${creator.profile}` : "/public/image/user/none.png"}
                />
                <b>
                  <span
                    className="dark:hover:text-blue-450 dark:text-white text-gray-400 font-semibold  text-xs transition duration-200 hover:text-gray-800"                    
                  >
                    {creator.name}
                  </span>
                </b>
              ...
              <div className="flex items-center space-x-reverse space-x-2">
                <Link
                  ...
                  className="group flex dark:hover:!text-white dark:bg-blue-300 dark:!bg-opacity-10 dark:text-blue-950 text-blue-700 items-center px-2 font-semibold text-xs  py-1 rounded bg-blue-40 transition duration-200 hover:bg-blue-700 hover:text-white"
                >
                  <svg
                    className="ml-1"
                    width="10"
                  ...
                  >
                    <path
                      className="fill-current transition duration-200 text-blue-700 group-hover:text-white"
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                    ...
                    ></path>
                    <path
                      className="stroke-current transition duration-200 text-blue-700 group-hover:text-white"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <Link
                  to={`/article/${shortName}`}
                  className="flex items-center px-1 h-5 ml-2 text-xs text-gray-500 dark:hover:bg-gray-940 dark:hover:text-gray-500 dark:bg-gray-500 dark:bg-opacity-10 dark:text-gray-940 bg-gray-500 bg-opacity-10 rounded"
                >
                  <svg
                    className="ml-1"
                    width="12"
                  ...
                  >
                    <path
                      ...
                      stroke="#607496"
                      stroke-width="0.960719"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    ></path>
                    <path
                      d="M6.47668 4.67017H8.39812"
                      stroke="#607496"
                      stroke-width="0.960719"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                ...
                <button className="flex group items-center px-1 h-5 ml-2 text-xs text-red-450 bg-red-700 dark:text-red-650 dark:hover:text-white dark:hover:bg-red-650 bg-opacity-10 rounded transition duration-200 hover:bg-opacity-100 hover:text-white">
                  <svg
                  ...
                  >
                    <path
                      className="stroke-current transition duration-200 dark:group-hover:bg-red-650 text-red-450 group-hover:text-white"
                      ...
                      stroke="#E81C4D"
                      stroke-width="0.761705"
                    ></path>
                  </svg>
                  {Math.ceil(Math.random() * 100)}
                </button>
                <button className="group flex items-center px-1 dark:hover:bg-blue-970 dark:hover:text-blue-700 dark:bg-blue-700 dark:text-blue-970 dark:bg-opacity-10 bg-blue-700 bg-opacity-10 h-5 rounded transition duration-200 hover:bg-opacity-100">
                  <svg
                    width="10"
                    height="12"
                    fill="none"
                  ...
                  >
                    <path
                      className="stroke-current text-blue-700 group-hover:text-white"
              ...
              <div className="flex items-center font-medium text-xs dark:text-gray-980 text-gray-400">
                <svg
                  className="ml-1"
                  width="10"
                  height="12"
                ...
                زمان مطالعه: {Math.ceil(Math.random() * 20)} دقیقه
              </div>
            </div>
          </div>
        </div>
