      ...
      <div className="container">
        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="xl:col-span-3 md:col-span-4 sm:col-span-6 col-span-12 mb-15">
            <div className="shadow-smswiper-slide-active rounded-lg bg-white dark:bg-dark-930 relative pt-32 flex justify-center h-full">
              <div className="absolute -top-12 w-full  px-4 ">
                <a
                  href="/series/web-design-projects"
                ...
                >
                  <img
                    ...
                    src="https://static.roocket.ir/images/cover/2024/3/14/qmLca1lqtoFe1kwJmBGe5lJ9ET17agVL2D8nQGwb.jpg"
              ...
              <div className="flex flex-col flex-1 w-full space-y-2">
                <div className=" px-4 flex flex-col flex-grow">
                  <span className="flex items-center text-blue-700 font-semibold text-xs mb-2">
                    <svg
                      className="ml-1"
                      width="7"
                      height="7"
                  ...
                  <p className="mb-2 text-gray-360 dark:text-gray-940 text-sm font-normal  overflow-hidden leading-6">
                    آموزش پروژه محور طراحی سایت به شما کمک می‌کند که به سادگی
                    بتوانید پروژه‌های طراحی سایت خود را پیاده‌سازی کنید.
                  </p>
                </div>
                ...
                <div>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center">
                        <div className="flex items-center bg-gray-100 dark:bg-gray-960 px-2 h-6 rounded ml-2">
                          <svg
                            className="ml-1 text-gray-500 dark:text-gray-950"
                            width="15"
                            height="14"
                            viewBox="0 0 15 14"
                            fill="none"
                  ...
                  <div className="flex justify-center border-t border-gray-300 border-opacity-10">
                    <a
                      href="/series/web-design-projects"
                      className="flex items-center my-4 transform group 0 font-bold text-base transition duration-200 dark:hover:text-gray-20 hover:text-dark-700 text-blue-700 dark:text-blue-950"
                    >
          ...
          <div className="xl:col-span-3 md:col-span-4 sm:col-span-6 col-span-12 mb-15">
            <div className="shadow-smswiper-slide-active rounded-lg bg-white dark:bg-dark-930 relative pt-32 flex justify-center h-full">
              <div className="absolute -top-12 w-full  px-4 ">
                <a
                  href="/series/laravel-eloquent"
                  className=" inline-block h-40 overflow-hidden w-full rounded-lg"
                >
                  <img
                    className="w-full h-full object-cover transform transition duration-200 hover:scale-110"
                    src="https://static.roocket.ir/images/cover/2024/3/17/cjrvYIIKwBOgP9NlKHeWYi4bXIcwIe9UQHZNlAbs.jpg"
                    alt="آموزش جامع Eloquent در لاراول"
                  />
                </a>
              </div>
              <div className="flex flex-col flex-1 w-full space-y-2">
                <div className=" px-4 flex flex-col flex-grow">
                  ...
                  <p className="mb-2 text-gray-360 dark:text-gray-940 text-sm font-normal  overflow-hidden leading-6">
                    در دوره آموزش جامع Eloquent در لاراول از ابتدایی ترین مفاهیم
                    تا مفاهیم پیشرفته تر و پیچیده مرتبط با Eloquent به شکل
                    کاربردی و در قالب مثال ها و سناریو...
                  </p>
                </div>
            ...
            <div className="shadow-smswiper-slide-active rounded-lg bg-white dark:bg-dark-930 relative pt-32 flex justify-center h-full">
              ...
              <div className="flex flex-col flex-1 w-full space-y-2">
                <div className=" px-4 flex flex-col flex-grow">
                  ...
                  <a href="/series/learn-nextjs" className="mb-2 inline-block">
                    <span className="text-xl font-bold text-gray-800 dark:hover:text-blue-450 dark:text-white hover:text-blue-700 duration-200 transition">
                      آموزش Next.js
                    </span>
                  </a>
                  <p className="mb-2 text-gray-360 dark:text-gray-940 text-sm font-normal  overflow-hidden leading-6">
                    دوره آموزش Next.js به شما کمک می‌کند SSR را برای React به
                    سادگی راه‌اندازی کنید و یک وبسایت با سئو مناسب با React
                    بوجود آورید.
                  </p>
                </div>
          ...
          <div className="xl:col-span-3 md:col-span-4 sm:col-span-6 col-span-12 mb-15">
            <div className="shadow-smswiper-slide-active rounded-lg bg-white dark:bg-dark-930 relative pt-32 flex justify-center h-full">
              <div className="absolute -top-12 w-full  px-4 ">
                <a
                  href="/series/woocommerce-complete-tutorial"
                  className=" inline-block h-40 overflow-hidden w-full rounded-lg"
                >
                  <img
                    className="w-full h-full object-cover transform transition duration-200 hover:scale-110"
                    src="https://static.roocket.ir/images/cover/2024/3/15/EbATSic1DTWuA71kKNttARiXVVuDGyVRhEZ5Gfp1.jpg"
                    alt="آموزش جامع ووکامرس"
                  />
                </a>
              </div>
              <div className="flex flex-col flex-1 w-full space-y-2">
                <div className=" px-4 flex flex-col flex-grow">
                  ...
                  <p className="mb-2 text-gray-360 dark:text-gray-940 text-sm font-normal  overflow-hidden leading-6">
                    با یادگیری ووکامرس می‌توانید وبسایت های فروشگاهی مد خود را
                    با وردپرس به شکل کامل پیاده سازی کنید.
                  </p>
                </div>
          ...
          <div className="xl:col-span-3 md:col-span-4 sm:col-span-6 col-span-12 mb-15">
            <div className="shadow-smswiper-slide-active rounded-lg bg-white dark:bg-dark-930 relative pt-32 flex justify-center h-full">
              <div className="absolute -top-12 w-full  px-4 ">
                <a
                  href="/series/telegram-bot-with-laravel"
                  className=" inline-block h-40 overflow-hidden w-full rounded-lg"
                >
                  <img
                    className="w-full h-full object-cover transform transition duration-200 hover:scale-110"
                    src="https://static.roocket.ir/images/cover/2023/12/1/9b04K1DH2DpNew697kBVLIJ9bdeIISvWAUSb3nW6.jpg"
                    alt="ساخت ربات تلگرام با لاراول"
                  />
                </a>
              </div>
              <div className="flex flex-col flex-1 w-full space-y-2">
                <div className=" px-4 flex flex-col flex-grow">
                  ...
                  <p className="mb-2 text-gray-360 dark:text-gray-940 text-sm font-normal  overflow-hidden leading-6">
                    ساخت ربات تلگرام با لاراول کار سختی نیست، البته اگر شما راه
                    درست انجام اینکار را بلد باشید، در طی این دوره موارد مختلف
                    راه‌اندازی ربات تلگرامی با لارا...
                  </p>
                </div>
          ...
          <div className="xl:col-span-3 md:col-span-4 sm:col-span-6 col-span-12 mb-15">
            <div className="shadow-smswiper-slide-active rounded-lg bg-white dark:bg-dark-930 relative pt-32 flex justify-center h-full">
              <div className="absolute -top-12 w-full  px-4 ">
                <a
                  href="/series/learn-react-advanced"
                  className=" inline-block h-40 overflow-hidden w-full rounded-lg"
                >
                  <img
                    className="w-full h-full object-cover transform transition duration-200 hover:scale-110"
                    src="https://static.roocket.ir/images/cover/2024/3/1/aE9nP6wnSnB9ib0M1Q6HelLDM2UZtBf1Bo5LAUhu.jpg"
                    alt="آموزش پیشرفته React"
                  />
                </a>
              </div>
              <div className="flex flex-col flex-1 w-full space-y-2">
                <div className=" px-4 flex flex-col flex-grow">
                  ...
                  <p className="mb-2 text-gray-360 dark:text-gray-940 text-sm font-normal  overflow-hidden leading-6">
                    آموزش پیشرفته React دوره‌ای است که در آن شما به صورت عمیق‌تر
                    و حرفه‌ای‌تر با ویژگی React آشنا می‌شوید و از آن‌ها به صورت
                    عملی در پروژه‌های خود استفاده...
                  </p>
                </div>
          ...
          <div className="xl:col-span-3 md:col-span-4 sm:col-span-6 col-span-12 mb-15">
            <div className="shadow-smswiper-slide-active rounded-lg bg-white dark:bg-dark-930 relative pt-32 flex justify-center h-full">
              <div className="absolute -top-12 w-full  px-4 ">
                <a
                  href="/series/whats-new-in-laravel-11"
                  className=" inline-block h-40 overflow-hidden w-full rounded-lg"
                >
                  <img
                    className="w-full h-full object-cover transform transition duration-200 hover:scale-110"
                    src="https://static.roocket.ir/images/cover/2024/3/19/ctYWILBCgvB3acniqYi5iir43A8c6uhrXFLW4LO8.jpg"
                    alt="آشنایی با امکانات جدید لاراول 11"
                  />
                </a>
              </div>
              <div className="flex flex-col flex-1 w-full space-y-2">
                <div className=" px-4 flex flex-col flex-grow">
                  ...
                  <p className="mb-2 text-gray-360 dark:text-gray-940 text-sm font-normal  overflow-hidden leading-6">
                    لاراول ۱۱ منتشر شد. در این دوره آموزشی با امکانات جدید
                    لاراول ۱۱ به شکل کامل آشنا خواهید شد.
                  </p>
                </div>
          ...
          <div className="xl:col-span-3 md:col-span-4 sm:col-span-6 col-span-12 mb-15">
            <div className="shadow-smswiper-slide-active rounded-lg bg-white dark:bg-dark-930 relative pt-32 flex justify-center h-full">
              <div className="absolute -top-12 w-full  px-4 ">
                <a
                  href="/series/laravel-restful-api-practical"
                  className=" inline-block h-40 overflow-hidden w-full rounded-lg"
                >
                  <img
                    className="w-full h-full object-cover transform transition duration-200 hover:scale-110"
              ...
              <div className="flex flex-col flex-1 w-full space-y-2">
                <div className=" px-4 flex flex-col flex-grow">
                  ...
                  <p className="mb-2 text-gray-360 dark:text-gray-940 text-sm font-normal  overflow-hidden leading-6">
                    در دوره آموزشی RESTful API در لاراول شیوه پیاده‌سازی REST
                    API در پروژه‌های لاراولی را به صورت عملی و کاربردی (براساس
                    نیاز بازار کار) یاد خواهید گرفت.
                  </p>
                </div>
