                ...
                <div className="lg:w-2/6 w-full relative lg:order-last order-first lg:mr-14 lg:h-64 sm:h-80 h-48 lg:mb-0 mb-5 overflow-hidden rounded">
                  {course ? (
                    course.sessions.length ? 
                     (<video 
                        src={`https://sabzlearnsite-backend.liara.run/courses/covers/${course?.sessions[0].video}`}
                        poster={`https://sabzlearnsite-backend.liara.run/courses/covers/${course?.cover}`}
                    ...
                    : (<img
                      ...
                      src={`https://sabzlearnsite-backend.liara.run/courses/covers/${course?.cover}`}
                      alt={course.name}
                    />)
                  ) : (
