...
const SessionsSection = memo(() => {
  ...
  return (
    ...
    >
      <h2 onClick={() => {
        setToLocal("token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2YmY2YTAxNzQ4YjUyODMxYTdkNDI1MyIsImlhdCI6MTcyODE0MjU1NCwiZXhwIjoxNzMwNzM0NTU0fQ.UpxaLsbjye8jOn0DP9XQjaf2yyQ9yDiMxa3qRb9QLNI")
        auth?.getMe()
